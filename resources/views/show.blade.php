...
@section('content')
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none">
                <img src="{{ $game['coverImageUrl'] }}" alt="game image"
                     class="w-64 hover:opacity-75 transition ease-in-out duration-150">
            </div>
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="flex items-center ml-12">
                        <div id="criticRating" class="w-16 h-16 bg-gray-800 rounded-full relative text-xs font-semibold">
                            @push('scripts')
                                @include('partials._rating', [
                                  'slug' => 'criticRating',
                ...
                @if($game['gameTrailer'])
                    <div class="mt-12" x-data="{ isOpen: false }">
                        ...
                        <div style="background-color: rgba(0, 0, 0, .5);"
                            ...
                            <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                                <div class="bg-gray-900 rounded" @click.away="isOpen = false">
                                    ...
                                    <div class="modal-body px-8 pb-8 pt-3">
                                        <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                            <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full"
                                                    src="{{ $game['gameTrailer'] }}"
                                                    style="border:0;"
        ...
        @if($game['screenshots'])
            <div class="images-container border-b border-gray-800 pb-12 mt-8" x-data="{ isOpen: false, image: '' }">
                <h2 class="text-blue uppercase tracking-wide font-semibold">Images</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                    @foreach($game['screenshots'] as $screenshot)
                        <div @click="
                            isOpen = true
                            image = '{{ $screenshot['huge'] }}'">
                            <img src="{{ $screenshot['big'] }}" alt="screenshot" class="cursor-pointer hover:opacity-75 transition ease-in-out duration-150">
                        </div>
                    @endforeach
        ...
        <div class="similar-games-container mt-8">
            <h2 class="text-blue uppercase tracking-wide font-semibold">Similar Games</h2>
